...
UPLOAD_FOLDER = r'C:\Users\ankit tiwari\Desktop\assignment\static\images\products'
...
def send_mail(id):
    ...
    name = res[0]['name']
    price = res[0]['price']
    fromaddr = "assip7317@gmail.com"
    toaddr = "tiwari.ankit9700@gmail.com"
    msg = MIMEMultipart()
    msg['From'] = fromaddr
    msg['To'] = toaddr
    msg['Subject'] = "Product Information"
    mail_text = " Product name: %s \n Price: %s " % (name, price)
    body = mail_text
    msg.attach(MIMEText(body, 'plain'))
    server = smtplib.SMTP('smtp.gmail.com', 587)
    server.starttls()
    server.login(fromaddr, "asdfgbvcxz123")
    text = msg.as_string()
